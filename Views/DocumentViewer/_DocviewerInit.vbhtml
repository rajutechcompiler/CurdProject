...
<script type="text/javascript">
    ...
    func.isError = '@Model.isError'
    func.ErrorMsg = '@Model.ErrorMsg '


    window.onload = function () {

         if ('@Model.isPermission' == 'False') {
             return showAjaxReturnMessage('@Languages.Translation("msgAttachmentPermissionsRevoked")' , "e");
             //["Please contact administrator, as one/more permissions has been revoked to access the attachment/s"]
    }
    }
