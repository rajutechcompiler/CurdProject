    ...
    $.ajax({
     ...
     $('#btnEditGroup').on('click', function () {
         ...
         if (rowSelection == null) {
             showAjaxReturnMessage(vrSecurityRes['msgJsSTUSelectARowGroup'], 'w');
             return;
         }
         else {
     ...
     $('#btnAssignMembers').on('click', function () {
         ...
         $.post(urls.Security.GetAllUsersList, function (data) {
             ...
             $.post(urls.Security.GetAssignedUsersForGroup, $.param({ pGroupId: GroupID }, true), function (data) {
         ...
         $('#btnSaveUsrToGrp').off().on('click', function () {
             ...
             if (IDs.length == 0) {
                 IDs.push("None");
                 showAjaxReturnMessage(vrSecurityRes['msgPleaseselectoneassign'], 'w');
                 return
             }
