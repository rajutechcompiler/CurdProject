...
$(function () {
    ...
    $('#frmNewWorkGroup').validate({
        ...
        messages: {
            WorkGroupName: { required: "", minlength: vrDatabaseRes["msgJsMapMin3CharValidationdatabase"] }
        },
    ...
    $(jsTreeName).on("rename_node.jstree", function (e, data) {
        ...
        if (data.old.toUpperCase() != data.text.toUpperCase()) {
            ...
            if (newNode.length < 3 || vRenameOperation == "") {
                if (vNodeId[1] == "root") {
                    lErrorMsg = lErrorMsg + "<li>" + vrDatabaseRes["msgJsMapMin3CharValidationapplication"] + "</li>" + "\n";
                } else {
